...
const HeroSection: FC = () => {
    ...
    return (
        <header className="text-white h-screen md:h-auto md:py-64 relative flex justify-center" style={{ backgroundImage: "url(Deco2.jpg)", backgroundPosition: "center center", backgroundSize: "cover" }}>
